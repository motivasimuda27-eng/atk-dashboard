...
function renderDashboard(storageData) {
    ...
    if (storageData.length === 0) {
        dashboardContent.innerHTML = '<p>Belum ada data item.</p>';
        return;
    }
    
    dashboardContent.innerHTML = storageData.map(storage => {
        // Tampilkan maksimal 5 item preview
        ...
        return `
            <div class="dashboard-card">
                ...
                <div class="dashboard-card-body">
                    ...
                    ${hasMore ? `
                        <button class="btn-show-all" onclick="showAllItems('${storage.location}', ${JSON.stringify(storage.items).replace(/"/g, '&quot;')})">
...
function showAllItems(location, items) {
        ...
        <div id="allItemsModal" class="modal show">
            <div class="modal-content modal-large">
                <div class="modal-header">
                    <h2>📍 ${location} - Semua Item (${itemsArray.length})</h2>
